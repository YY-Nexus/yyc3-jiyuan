...
export default function ArticleManagement() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white p-4 border-b text-sm text-gray-500">
          <div className="flex items-center space-x-2">
            <span>管理工具</span>
            <span>/</span>
            <span className="text-gray-800">营销文章管理</span>
          </div>
          <h1 className="text-xl font-medium mt-2 text-gray-800">营销文章管理</h1>
        </div>
          ...
          <div className="bg-white rounded-md shadow-sm">
            ...
            <div className="p-4 border-b flex items-center flex-wrap gap-4">
              <div className="flex items-center">
                <span className="mr-2 whitespace-nowrap">文章名称:</span>
                <Input
                  placeholder="请输入文章名称"
                  className="w-56"
                  value={searchTitle}
                ...
                <TableBody>
                  {articles.map((article) => (
                    <TableRow key={article.id}>
                      ...
                      <TableCell>{article.shareCount}</TableCell>
      ...
      {/* 发布文章表单 */}
      <ArticleFormDialog isOpen={isFormOpen} onClose={() => setIsFormOpen(false)} onSubmit={handleFormSubmit} />
    </div>
  )
}
